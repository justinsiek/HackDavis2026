    ...
    >
      ...
      <div style={{ position: "relative", width: size, height: size }}>
        ...
        <motion.div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(71,128,255,0.55) 0%, rgba(71,128,255,0.28) 45%, transparent 70%)",
            filter: "blur(22px)",
            opacity: isActive ? glowOpacity : isQuiet ? 0.1 : 0.22,
            pointerEvents: "none",
          }}
          animate={
            !isActive && !isQuiet
        ...
        >
          ...
          <motion.div
            animate={{ opacity: [0.82, 1, 0.72, 0.9, 0.82], x: [0, 14, -9, 7, 0], y: [0, -11, 9, -7, 0] }}
            transition={{ opacity: LOOP_8, x: LOOP_8, y: LOOP_8 }}
          ...
          <motion.div
            animate={{ opacity: [0.68, 0.88, 0.58, 0.78, 0.68], x: [0, -15, 9, -11, 0], y: [0, 9, -13, 11, 0] }}
            transition={{ opacity: LOOP_9, x: LOOP_9, y: LOOP_9 }}
          ...
          <motion.div
            animate={{ opacity: [0.6, 0.8, 0.52, 0.72, 0.6], x: [0, 11, -13, 9, 0], y: [0, 15, -9, 13, 0] }}
            transition={{ opacity: LOOP_11, x: LOOP_11, y: LOOP_11 }}
          ...
          <motion.div
            animate={{ opacity: [0.64, 0.84, 0.5, 0.74, 0.64], x: [0, -11, 15, -9, 0], y: [0, -13, 11, -15, 0] }}
            transition={{ opacity: LOOP_12, x: LOOP_12, y: LOOP_12 }}
      ...
      <div
        style={{
          width: size * 0.65,
          height: 16,
          background: "rgba(71,128,255,0.1)",
          filter: "blur(14px)",
          borderRadius: "50%",
        }}
      />
